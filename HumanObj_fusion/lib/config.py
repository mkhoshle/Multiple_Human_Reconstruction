...
project_dir = currentfile.replace(os.sep + 'HumanObj_fusion' + os.sep + 'lib' + os.sep + 'config.py','')
...
def parse_args(input_args=None):
    ...
    train_group.add_argument('--N_frames_per_window', type = int, default = 1, help = 'No of frames per window')
    train_group.add_argument('--fusion', type = bool, default = False, help = 'Whether to use fusion')
