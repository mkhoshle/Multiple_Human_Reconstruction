...
project_dir = currentfile.replace(os.sep + 'HumanObj' + os.sep + 'lib' + os.sep + 'config.py','')
...
def parse_args(input_args=None):
    ...
    parser.add_argument('--tab', type = str, default = 'HBOJ_v1', help = 'additional tabs')
    ...
    train_group.add_argument('--epoch', type = int, default = 30, help = 'training epochs')
    train_group.add_argument('--fine_tune',type = bool, default = True, help = 'whether to run online')
    train_group.add_argument('--partial_load',type = bool, default = False, help = 'whether to load the model partially')
    ...
    train_group.add_argument('--fix_backbone_training_scratch',type = bool,default = True,help = 'whether to fix the backbone features if we train the model from scratch.')
    ...
    model_group.add_argument('--backbone',type = str,default = 'resnet101',help = 'backbone model: resnet50, resnet101')
