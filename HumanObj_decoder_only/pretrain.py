...
class Trainer(Base):
    def __init__(self):
        ...
        self.result_save_dir = '/z/home/mkhoshle/ROMP-old/pretrain_result_images'
    ...
    def set_up_validation(self):
        ...
        self.dataset_val_list['pw3d'] = self._create_single_data_loader(dataset='pw3d', train_flag=False, regress_smpl=False)
