...
class PW3D(Image_base):
    def __init__(self,train_flag = False, split='train', mode='normal', regress_smpl=True, **kwargs):
        #if train_flag:
...
#     def get_image_info_for_videos(self, image_name):
#         annots = self.annots[image_name]
...
#         return img_info
    ...
    def get_image_info(self, index):
        # print(index,self.file_paths[index%len(self.file_paths)],len(self.file_paths))
